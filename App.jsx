...
function App() {
  ...
  return (
    <div className="min-h-screen coffee-gradient">
      {/* Header */}
      <header className="bg-white/90 backdrop-blur-md border-b border-coffee-brown/20 sticky top-0 z-50">
        <div className="container mx-auto px-4 py-6">
          ...
          <p className="text-center text-coffee-medium mt-2 text-lg">
            Benefícios exclusivos para nossos clientes
          </p>
        </div>
      </header>
      ...
      <main className="container mx-auto px-4 py-8">
            ...
            <Button
              ...
              className={`${
                selectedCategory === category 
                  ? "bg-coffee-red-dark hover:bg-coffee-red text-coffee-cream" 
                  ...
                  <div className="space-y-2">
                    {fornecedor.contatos.telefone && (
                      <Button
                        variant="outline"
                        size="sm"
                        className="w-full justify-start contact-button border-coffee-brown"
        ...
        <footer className="mt-16 text-center">
          <Card className="coffee-card">
            <CardContent className="pt-6">
              <Coffee className="h-12 w-12 text-coffee-red-dark mx-auto mb-4" />
