...
with app.app_context():
    ...
    admin_exists = User.query.filter_by(email='admin@cafemaiolini.com').first()
    if not admin_exists:
        admin = User(
            email='admin@cafemaiolini.com',
            nome='Administrador',
            tipo_usuario='admin'
        )
        ...
        db.session.commit()
        print("Usuário admin criado: admin@cafemaiolini.com / admin123")
