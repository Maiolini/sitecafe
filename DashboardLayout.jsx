        ...
        <div className="fixed left-0 top-0 bottom-0 w-64 bg-white shadow-lg">
          <div className="flex items-center justify-between p-4 border-b border-[#ccb38c]">
            <div className="flex items-center gap-2">
              <Coffee className="w-6 h-6 text-[#3e2a1b]" />
              <span className="font-bold text-[#3e2a1b]">Café Maiolini</span>
            </div>
            <Button
              variant="ghost"
              size="sm"
          ...
          <div className="p-6 border-b border-[#ccb38c]">
            <div className="flex items-center gap-3">
              <Avatar className="w-10 h-10">
                <AvatarFallback className="bg-[#3e2a1b] text-[#f2e3ca]">
              ...
              <div className="flex-1 min-w-0">
                ...
                {user?.cliente && (
                  <div className="flex items-center gap-1 mt-1">
                    <Star className="w-3 h-3 text-[#785841]" />
                    <span className={`text-xs px-2 py-1 rounded-full ${getNivelColor(user.cliente.nivel_parceria)}`}>
                      {getNivelLabel(user.cliente.nivel_parceria)}
                    </span>
                  </div>
                )}
              </div>
      ...
      <div className="lg:pl-64">
        ...
        <div className="lg:hidden bg-white shadow-sm border-b border-[#ccb38c] p-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <Coffee className="w-5 h-5 text-[#3e2a1b]" />
              <span className="font-bold text-[#3e2a1b]">Café Maiolini</span>
            </div>

            <div className="flex items-center gap-2">
              <Avatar className="w-8 h-8">
                <AvatarFallback className="bg-[#3e2a1b] text-[#f2e3ca] text-xs">
                  {getInitials(user?.nome || 'U')}
                </AvatarFallback>
              </Avatar>
            </div>
